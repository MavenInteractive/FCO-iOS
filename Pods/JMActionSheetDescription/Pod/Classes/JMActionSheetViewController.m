...
static const CGFloat JMActionSheetButtonHeight          = 38.0f;
                             ...
                             andDelegate:(id <JMActionSheetViewControllerDelegate>)delegate
{
    ...
    //Cancel button
    NSInteger tag = 0;
    CGFloat yOffset = CGRectGetMaxY(self.view.bounds) - JMActionSheetButtonHeight - (JMActionSheetPadding + 45);
...
{
    UIColor *bckColor = [UIColor darkGrayColor];
